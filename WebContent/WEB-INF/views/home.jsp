        ...
        <div class="_1200px flex_between pd-10_0">
            <div class="nav_left">
                ...
                <form action="search.htm">
                    <input type="text" name = "keyword" placeholder="Nhập sản phẩm cần tìm kiếm..." <c:out value = "${keyword}"/>>
            ...
            <div class="category_carousel_left bg-white">
                ...
                <ul class="category_ul">
                	<c:forEach var = "i" begin = "0" end =  "4">
                    	<li class="category_ui_item pd-10"><a href="category/${categories[i].getCategory_id()}.htm">${categories[i].getCategory_name()}</a></li>
            		</c:forEach>
                </ul>
            </div>
